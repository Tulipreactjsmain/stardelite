...
export default function Unstop() {
  return (
    <svg
      ...
      style={{ enableBackground: "new 0 0 2000 796" }}
      xmlSpace="preserve"
    >
      <style type="text/css">
        {".st0-unstop{fill-rule:evenodd;clip-rule:evenodd;fill:#1C4980;}"}
      </style>
      <g>
        <path
          class="st0-unstop"
        ...
        <path
          class="st0-unstop"
          d="M1297.3,300.9h-46.4v173.6c0,28.3,5.1,35.1,27.1,35.1c6.8,0,10.7-0.6,19.2-1.7v57.7
		c-15.3,4.5-28.8,6.2-48.1,6.2c-54.3,0-81.4-24.9-81.4-75.2V300.3H1127v-54.9h40.7V160h83.1v85.4h46.4v55.5H1297.3z"
        />
        <path
          class="st0-unstop"
          d="M1647.4,405.5c0,102.9-60.5,166.8-158.4,166.8c-98.4,0-158.3-63.9-158.3-169.1c0-104.6,59.9-169.1,157.8-169.1
        ...
        <path
          class="st0-unstop"
          d="M1777.2,286.7c20.4-35.6,48.6-52.6,88.8-52.6c38.5,0,78,20.4,99.5,50.3c21.5,29.4,34.5,74.6,34.5,119.3
        ...
        <path
          class="st0-unstop"
          d="M397.6,0.4C178.6,0.4,0,179,0,398s178.6,397.6,397.6,397.6S795.2,617,795.2,398C795.1,179,616.5,0.4,397.6,0.4
