...
export default function Paystack() {
  return (
    <svg
      ...
      style={{ enableBackground: "new 0 0 280.6 50" }}
      xmlSpace="preserve"
    >
      <style type="text/css">
        {".st0-paystack{fill:#00C3F7;} .st1-paystack{fill:#011B33;}"}
      </style>
      <g>
        <g>
          <path
            class="st0-paystack"
            d="M39.9,4.8H2.3C1.1,4.8,0,5.8,0,7.1v4.2c0,1.3,1.1,2.4,2.3,2.4h37.6c1.3,0,2.3-1.1,2.4-2.4V7.2
          ...
          <path
            class="st1-paystack"
            d="M86,14.3c-1.2-1.2-2.5-2.1-4.1-2.8c-1.5-0.7-3.2-1-4.9-1c-1.6,0-3.2,0.3-4.7,1c-1,0.5-1.9,1.1-2.6,1.9v-0.7
